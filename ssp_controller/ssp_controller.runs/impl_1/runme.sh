...
HD_PWD='C:/Users/aleen/Documents/College/Fall2025/VLSI/ssp_controller/ssp_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_clk_div2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_clk_div2.tcl -notrace
