...
HD_PWD='C:/Users/aleen/Documents/College/Fall2025/VLSI/ssp_controller/ssp_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_clk_div2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_clk_div2.tcl
